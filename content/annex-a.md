...
[`<pkg>-lint`](action-pkg-lint)
[`<pkg>-patch`](action-pkg-patch)
[`<pkg>-printvars`](action-pkg-printvars)
...
[`RELENG_HOST_OS_LINUX`](env-releng-host-os-linux)
[`RELENG_HOST_OS_MACOS`](env-releng-host-os-macos)
[`RELENG_HOST_OS_WINDOWS`](env-releng-host-os-windows)
...
[`RELENG_RELEASE`](env-releng-release)
...
[`LIBFOO_EXCLUDE_SBOM`](pkg-opt-exclude-sbom) = bool
...
[`LIBFOO_REMOTE_CONFIG`](pkg-opt-remote-config) = bool   *(deprecated)*
...
[`releng_is_api_mode`](releng_tool.releng_is_api_mode)()
[`releng_is_debug_mode`](releng_tool.releng_is_debug_mode)()
[`releng_is_verbose_mode`](releng_tool.releng_is_verbose_mode)()
...
[`releng.ignore_failed_extensions`](quirk-releng.ignore_failed_extensions)
[`releng.ignore_release_check`](quirk-releng.ignore_release_check)
